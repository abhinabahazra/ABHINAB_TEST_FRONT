...
class TestBox extends Component {
    ...
    endTheTest = () => {
        console.log(  "abhinab",sessionStorage.getItem('auth'))
        if(sessionStorage.getItem('auth')){
        let {test_can} = JSON.parse(sessionStorage.getItem('auth'))
        let id = test_can
        axios.post("https://www.apitest45.techmagnox.com/exam_api/finished",{id}).then((resp)=>{
